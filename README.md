...
Having found this code in a newer version written in C++, I've written a version in Python that will create any number
of insults using a model file, then either write these insults to the terminal or, even better, to an iOS app that is
currently being written using React Native, Expo and TestApp.io.
